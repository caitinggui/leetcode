...
class Solution(object):
    def getImportance_slow(self, employees, id):
        """
        ...
        for i, x in enumerate(subordinates):
            importance += self.getImportance(employees, x)
        return importance
    ...
    def getImportance2(self, employees, id):
        ...
        def dfs(eid):
              ...
              for i, x in enumerate(employee.subordinates):
                  importance += dfs(x)
              return importance
        return dfs(id)
    ...
    def getImportance(self, employees, id):
        ...
        importance = 0
        while stack:
            employee = emap[stack.pop()]
            importance += employee.importance
            stack += employee.subordinates
        return importance


employees = [Employee(1, 3, [2, 3]), Employee(2, 5, [4]), Employee(3, 1, []), Employee(4, 10, [])]
s = Solution()
